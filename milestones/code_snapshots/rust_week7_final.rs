// Week 7: Final snapshot — full application
// This file is a snapshot of the final GUI application as present in `src/main.rs`.
// It is intentionally a near-exact copy so milestones/code_snapshots contains a self-
// contained reference version. If you update `src/main.rs`, consider updating this
// snapshot so the milestone history stays consistent.
